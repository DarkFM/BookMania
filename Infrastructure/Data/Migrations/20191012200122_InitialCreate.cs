        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingAddress_CountryProvince = table.Column<string>(nullable: true),
                    ShippingAddress_ZipOrPostCode = table.Column<string>(nullable: true),
                    ShippingAddress_AddressLine1 = table.Column<string>(nullable: true),
                    ShippingAddress_AddressLine2 = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    UserId = table.Column<int>(nullable: false),
                    CardNumberHash = table.Column<byte[]>(nullable: false),
                    CardSecurityKeyHash = table.Column<byte[]>(nullable: false),
                    Salt = table.Column<byte[]>(nullable: false),
                    Last4 = table.Column<int>(nullable: false),
                    IsDefault = table.Column<bool>(nullable: false, defaultValue: false),
                    NameOnCard = table.Column<string>(maxLength: 255, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    BookOrdered_BookId = table.Column<int>(nullable: false),
                    BookOrdered_Title = table.Column<string>(maxLength: 255, nullable: false),
                    BookOrdered_ImageUrl = table.Column<string>(maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountryProvince = table.Column<string>(maxLength: 100, nullable: false),
                    ZipOrPostCode = table.Column<string>(maxLength: 15, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShipToAddress", x => x.OrderId);
                    table.ForeignKey(
                        name: "FK_ShipToAddress_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BillingAddress", x => x.PaymentDetailsId);
                    table.ForeignKey(
                        name: "FK_BillingAddress_PaymentDetails_PaymentDetailsId",
